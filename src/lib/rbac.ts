...
export const PERMISSIONS: Record<UserRole, string[]> = {
  founder: ['*'],
  super_admin: ['*'],
  hr_manager: ['applications.manage', 'applications.review', 'interns.manage', 'offers.generate', 'reports.view', 'links.generate', 'attendance.mark', 'attendance.manage', 'emails.send'],
  recruiter: ['applications.review', 'links.generate', 'interviews.schedule', 'emails.send'],
