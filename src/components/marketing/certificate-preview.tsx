    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <div className="order-2 lg:order-1">
          <div className="relative overflow-hidden rounded-2xl border-2 border-amber-400/50 bg-gradient-to-br from-white to-brand-50 p-6 shadow-glass sm:p-8">
            <div className="pointer-events-none absolute -left-7 -top-7 h-16 w-16 rotate-45 bg-ink-900" />
            <div className="relative flex items-center justify-between border-b border-dashed border-amber-400/50 pb-4">
              <LogoMark size={36} />
              <span className="rounded-full bg-ink-900 px-3 py-1 text-[10px] font-semibold text-amber-300">EARLY STAGE STARTUP</span>
            </div>
            <p className="mt-5 text-center font-display text-2xl font-bold tracking-wide text-ink-900">CERTIFICATE</p>
            <p className="text-center text-xs tracking-[0.3em] text-amber-600">◆ OF INTERNSHIP ◆</p>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-dashed border-amber-400/50 pt-4">
              <div>
        ...
        <div className="order-1 lg:order-2">
          ...
          <div className="mt-6 flex items-center gap-3 rounded-xl border border-brand-200 bg-brand-50 p-4">
            ...
            <p className="text-sm text-brand-800">
              ...
              <span className="font-semibold">careers.storeshift.in/certificate/verify</span>
            </p>
          </div>
        </div>
      </div>
