    ...
    Papa.parse(file, {
      ...
      complete: async (results) => {
        ...
        for (const row of rows) {
          ...
          // application_id is intentionally omitted — the DB's
          // trg_set_application_id trigger (migration 006) fills it in
          // atomically from application_id_seq. Generating it client-side
          // from "apps.length + row index" raced against concurrent
          // imports/submissions and could produce duplicate IDs.
