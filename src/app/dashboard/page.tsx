...
export default async function InternDashboardPage() {
  ...
  // Show the intern's most recent internship regardless of status —
  // filtering to status='active' meant a completed intern's dashboard
  // went permanently blank the moment their internship was marked done.
